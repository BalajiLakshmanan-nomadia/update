...
public final class Crouton {
  ...
  /** The Constant NULL_PARAMETERS_ARE_NOT_ACCEPTED. */
  ...
  /**
   * Checks if is crouton view not null.
   *
   * @return true, if is crouton view not null
   */
  ...
  /**
   * Checks if is custom view not null.
   *
   * @return true, if is custom view not null
   */
