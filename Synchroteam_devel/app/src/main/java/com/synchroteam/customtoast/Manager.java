...
final class Manager extends Handler {
  ...
  /**
   * Gets the single instance of Manager.
   *
  ...
  /**
   * Removes the crouton from view parent.
   *
   * @param crouton the crouton
   */
  ...
  /**
   * Removes the all messages for crouton.
   *
   * @param crouton the crouton
   */
