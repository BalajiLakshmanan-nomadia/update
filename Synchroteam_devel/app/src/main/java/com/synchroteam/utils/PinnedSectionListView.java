...
public class PinnedSectionListView extends ListView {
	...
	public static interface PinnedSectionListAdapter extends ListAdapter {
		 ...
		 * @return true, if is item view type pinned
		 */
    ...
    /**
     * Sets the shadow visible.
     *
     * @param visible the new shadow visible
     */
	...
	/* (non-Javadoc)
	 * @see android.widget.AbsListView#onRestoreInstanceState(android.os.Parcelable)
	 */
	@Override
    ...
    /**
     * Checks if is pinned view touched.
     *
     * @param view the view
     * @param x the x
     * @param y the y
     * @return true, if is pinned view touched
     */
    ...
    /**
     * Checks if is item view type pinned.
     *
