...
class IcsLinearLayout extends LinearLayout {
    ...
    /** The Constant LL_DIVIDER. */
    private static final int LL_DIVIDER = 0;
    
    /** The Constant LL_SHOW_DIVIDER. */
    private static final int LL_SHOW_DIVIDER = 1;
    
    /** The Constant LL_DIVIDER_PADDING. */
     ...
     * @param themeAttr the theme attr
     */
    ...
    /* (non-Javadoc)
     * @see android.widget.LinearLayout#setDividerDrawable(android.graphics.drawable.Drawable)
     */
