...
/**
 * The Class ScannerBar.
 */
public class ScannerBar extends Activity {
...
//        if (ContextCompat.checkSelfPermission(ScannerBar.this, Manifest.permission.READ_EXTERNAL_STORAGE)
//                != PackageManager.PERMISSION_GRANTED ||
//                ContextCompat.checkSelfPermission(ScannerBar.this, Manifest.permission.CAMERA)
//                        != PackageManager.PERMISSION_GRANTED ||
//                ContextCompat.checkSelfPermission(ScannerBar.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
//                        != PackageManager.PERMISSION_GRANTED) {
//
//        } else {
//            getBasic();
...
//                boolean w = grantResults[2] == PackageManager.PERMISSION_GRANTED;
//                if (Read && camera && w) {
//                    getBasic();
//
//                } else if (grantResults.length > 0 &&
//                        !ActivityCompat.shouldShowRequestPermissionRationale(ScannerBar.this, Manifest.permission.ACCESS_FINE_LOCATION)
//                        || !ActivityCompat.shouldShowRequestPermissionRationale(ScannerBar.this, Manifest.permission.READ_EXTERNAL_STORAGE)
//                        || !ActivityCompat.shouldShowRequestPermissionRationale(ScannerBar.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
//                ) {
//                    isRequestRequired = false;
//                    final androidx.appcompat.app.AlertDialog.Builder alertDialogBuilder = new androidx.appcompat.app.AlertDialog.Builder(this);
//                    alertDialogBuilder.setTitle("Permissions Required")
...
//    }
    ...
    private void requestPermission() {
        ...
        ActivityCompat.requestPermissions(ScannerBar.this,
    ...
    private void callingPermissionCamera() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(ScannerBar.this,
                Manifest.permission.READ_EXTERNAL_STORAGE) ||
                ActivityCompat.shouldShowRequestPermissionRationale(ScannerBar.this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(ScannerBar.this,
                    Manifest.permission.CAMERA)) {
                AlertDialog.Builder alertBuilder = new AlertDialog.Builder(ScannerBar.this);
                ...
                alert.show();
            } else if (ActivityCompat.shouldShowRequestPermissionRationale(ScannerBar.this,
                    Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                AlertDialog.Builder alertBuilder = new AlertDialog.Builder(ScannerBar.this);
                alertBuilder.setCancelable(true);
                alertBuilder.setTitle(getString(R.string.app_name));
...
//    }
     ...
     * @param data
     */
    public void saveByteBitmap(byte[] data) {
        FileOutputStream fos = null;
        try {
            File f = new File(getString(R.string.barcodeImageFilePath));
    ...
    public int getExitInterface() {
        int rotation = 0;
        ExifInterface exif;
        try {
            exif = new ExifInterface(getString(R.string.barcodeImageFilePath));
    ...
    PreviewCallback previewCb = new PreviewCallback() {
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (result != 0) {
                ...
                //to get the orentation of image
//                saveByteBitmap(data);
//                int rotationDegree = getExitInterface();
...
//                        deleteTempImage();
    ...
    private Bitmap ConvertYuvToJpeg(byte[] data, Camera camera) {
