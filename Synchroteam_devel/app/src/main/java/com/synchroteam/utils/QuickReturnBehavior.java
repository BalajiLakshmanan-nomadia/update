...
public class QuickReturnBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    private  boolean mIsFirstSwipeUp = true;
        ...
        if (mIsFirstSwipeUp) {
            if (dy < -10 && mDySinceDirectionChange == 0) {
                ...
                if (visibleItemPosition == 0) {
                    ...
                    //TODO change the header position and increment value of adapter to show the header
            ...
            if (mDySinceDirectionChange > child.getHeight()
                    ...
                    && !mIsHiding && lastVisibleItemPosition > 3) {
                hide(child);
