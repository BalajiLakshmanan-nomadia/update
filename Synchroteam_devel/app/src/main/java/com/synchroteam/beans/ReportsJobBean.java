...
/**
 * The Class ReportsJobBean  to hold data of Completed Jobs  .
 *
 * @author ${Ideavate Solution}
 */
public class ReportsJobBean {
...
//	private String nom_model_rapport;
    ...
    /**
     * Instantiates a new deadline job bean.
     *
     * @param id                    the id
     * @param desc                  the desc
     ...
     */
//	public ReportsJobBean(String id, String desc, int priorite,
...
//			String nom_model_rapport, int idUser ,String lat,String lon,String adr_interv_globale,String adr_interv_complement,int no_interv,String nom_client_sign,String nom_tech_sign,String nom_facture_sign,String nom_equipement,int idClient,int idSite,int idEquipement,String mobileContact,String dt_meeting,String ref_customer,String Id_interv_mere,String headerDate) {
//
//
//		super();
//		this.id = id;
...
//	}
    public ReportsJobBean(String id, String desc, int priorite,
                          ...
                          String adr_interv_globale,
                          String adr_interv_complement,
                          int no_interv, String nom_client_sign,
                          String nom_tech_sign, String nom_facture_sign,
                          String nom_equipement, int idClient, int idSite,
                          int idEquipement, String mobileContact,
