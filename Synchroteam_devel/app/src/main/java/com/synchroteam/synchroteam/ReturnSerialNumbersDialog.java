 ...
 *         serial numbers for <b> Return </b> and then navigate back to the
 *         previous activity.
 *         </p>
 */
public class ReturnSerialNumbersDialog extends Button {

    private Context context;
    private static List<InventoryDialogSerialNumber> items;
    private static ReturnSerialNumbersListener listener;
    ...
    private static ArrayList<String> listSelectedSerial;
    private static Typeface typeFace;
    private long mLastClickTime = 0;

    public ReturnSerialNumbersDialog(Context context) {
        super(context);
        this.context = context;
    }

    public ReturnSerialNumbersDialog(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    }
    ...
    public boolean performClick() {
        ...
        if (items == null) {
            ...
            if (items.size() == 0) {
                ...
                listSelectedSerial=new ArrayList<String>();
                // adding selected values for the first time
                for (int i = 0; i < items.size(); i++) {
                    if (items.get(i).isSelected()) {
                        listSelected.add(items.get(i).getName());
                        listSelectedSerial.add(items.get(i).getIdPieceSerial());
                    }
                }
            }
        }
    ...
    public void setItems(List<InventoryDialogSerialNumber> items,
                         String allText, int position, ReturnSerialNumbersListener listener) {
     ...
     */
    public interface ReturnSerialNumbersListener {
                    ...
                    for (int i = 0; i < len; i++) {
                        if (i == position) {
                            ...
                            if (data.isSelected()) {
                                ...
                                listSelectedSerial.add(data.getIdPieceSerial());
                            } else {
    ...
    public static class SerialNumberDialog extends DialogFragment {
        ...
        public void onDismiss(DialogInterface dialog) {
            ...
            listener.onItemsSelected(listSelected,listSelectedSerial);
        }
        ...
        private void initializeUI() {
            ...
            ReturnSerialNumbersDialog sn = new ReturnSerialNumbersDialog(
                    getActivity());
