...
import com.synchroteam.fragmenthelper.SiteDetilsFragmentHelper;
...
/**
 * The Fragment Class to Show Site details.
 * 
 * @author Trident
 */
public class SiteDetailFragment extends Fragment {
	...
	private SiteDetilsFragmentHelper siteDetailsFragmentHelper;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		siteDetailsFragmentHelper = new SiteDetilsFragmentHelper(
				(SiteDetail) getActivity(),
				bundle.getInt(KEYS.ClientDetial.ID_CLIENT),
				bundle.getInt(KEYS.SiteDetails.ID_SITE),
				bundle.getString(KEYS.ClientDetial.CLIENT_NAME),this);

		EventBus.getDefault().register(this);

		return siteDetailsFragmentHelper.inflateLayout(inflater, container);
	...
	public void onEvent(UpdateUiOnSync updateUiOnSync) {
		siteDetailsFragmentHelper.doOnSyncronize();
            ...
            case MY_PERMISSIONS_REQUEST_CALL_PHONE: {
                ...
                if (grantResults.length > 0
                    ...
                    if (ContextCompat.checkSelfPermission(getActivity(), Manifest.permission.CALL_PHONE)
                        ...
                        siteDetailsFragmentHelper.callingMethod();
                } else {
