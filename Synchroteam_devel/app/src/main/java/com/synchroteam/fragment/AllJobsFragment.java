...
import com.synchroteam.fragmenthelper.AllJobsFragmentHelperNew;
...
/**
 * This fragment shows all the jobs for an user.<p></p>
 * Created by Trident on 5/18/2016.
 */
public class AllJobsFragment extends BaseFragment implements AllJobsSortingDialog.SortingListener {
     ...
     * Helper class
     */
    AllJobsFragmentHelperNew allJobsFragmentHelper;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        allJobsFragmentHelper = new AllJobsFragmentHelperNew(getSyncroTeamBaseActivity(), this, this);
