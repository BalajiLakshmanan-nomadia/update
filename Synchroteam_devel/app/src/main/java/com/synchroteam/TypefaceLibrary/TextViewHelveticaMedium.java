 ...
 * The Class TextView.
 */
public class TextViewHelveticaMedium extends androidx.appcompat.widget.AppCompatTextView {
	 ...
	 *            the context
	 */
	public TextViewHelveticaMedium(Context context) {
		super(context);
		FontManager.getInstance().setFont(this,
				context.getString(R.string.fontName_helvetica_medium));
	 ...
	 *            the attrs
	 */
	public TextViewHelveticaMedium(Context context, AttributeSet attrs) {
		super(context, attrs);
