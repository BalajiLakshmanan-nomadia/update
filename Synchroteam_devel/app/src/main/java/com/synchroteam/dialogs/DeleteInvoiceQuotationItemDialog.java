...
public class DeleteInvoiceQuotationItemDialog extends Dialog {
	 ...
	 */
	public DeleteInvoiceQuotationItemDialog(Context context,
											DeleteInvoiceQuotationInterface deleteIQInterface) {
		super(context, android.R.style.Theme_Translucent_NoTitleBar);
		setCancelable(false);
		setContentView(R.layout.layout_delete_invoice_quotation_item_dialog);
