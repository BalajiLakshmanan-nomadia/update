...
public class ConvertToInvoiceDialog extends Dialog {
	...
	private ConvertToInvoiceDialogInterface deleteIQInterface;

	/**
	 * The Interface DeleteInvoiceQuotationInterface.
	 */
	public interface ConvertToInvoiceDialogInterface {
	 ...
	 */
	public ConvertToInvoiceDialog(Context context, boolean isInvoice,
								  ConvertToInvoiceDialogInterface deleteIQInterface) {
		super(context, android.R.style.Theme_Translucent_NoTitleBar);
		setCancelable(false);
		setContentView(R.layout.layout_convert_invoice_dialog);
