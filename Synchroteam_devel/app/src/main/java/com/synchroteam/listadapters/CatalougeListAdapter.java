...
public class CatalougeListAdapter extends BaseAdapter {
     ...
     * @param attachmentBeans            the attachment beans
     * @param dataAccessObject           the data access object
     * @param idInterventiion            the id interventiion
     */
    public CatalougeListAdapter(JobDetails jobDetails,
    ...
    public HashMap<String, String> getItem(int position) {
        ...
        return attachmentBeans.get(position);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        @SuppressWarnings("unchecked") final ViewHolder viewHolder;
        if (convertView == null) {

            convertView = layoutInflater.inflate(
                    R.layout.layout_catalouge_item_listview_new, parent,false);

            viewHolder = new ViewHolder();
            viewHolder.categoryDataTv = (TextView) convertView
                    .findViewById(R.id.categoryDataTv);
            viewHolder.txtPriceLabel = (TextView) convertView
                    .findViewById(R.id.txtPriceLabel);
            viewHolder.removeImageIcon = (TextView) convertView
                    .findViewById(R.id.removeImageIcon);
            // viewHolder.itemNameDataTv = (TextView) convertView
            // .findViewById(R.id.itemNameDataTv);

            viewHolder.dataQantitiyEt = (TextView) convertView
                    .findViewById(R.id.dataQantitiyEt);
            viewHolder.txtQtyBelow = (TextView) convertView
                    .findViewById(R.id.txt_qty_left);
            viewHolder.costTv = (TextView) convertView
                    .findViewById(R.id.costTv);
            // viewHolder.currencyTv = (TextView) convertView
            // .findViewById(R.id.currencyTv);

            viewHolder.txtSelectIcon = (android.widget.TextView) convertView
                    .findViewById(R.id.txtSelectSerialNo);

            viewHolder.relSerialNumbers = (RelativeLayout) convertView
                    .findViewById(R.id.relSerialContainer);

            viewHolder.relSerializable = (RelativeLayout) convertView
                    .findViewById(R.id.relSerialNo);

            Typeface typeFace = Typeface.createFromAsset(
                    jobDetails.getAssets(),
                    jobDetails.getString(R.string.fontName_fontAwesome));
            viewHolder.txtSelectIcon.setTypeface(typeFace);
        ...
        viewHolder.dataQantitiyEt.setOnClickListener(new OnClickListener() {
...
//                                        itemCostTotal = arrondi(itemCostTotal);
                                        ...
                                        CatalougeListAdapter.this.getItem(pos)
                                                .put(KEYS.JObDetail.QTE,
                                                        pieces + "");

                                        CatalougeListAdapter.this
                                                .getItem(pos)
        ...
        viewHolder.txtQtyBelow.setOnClickListener(new OnClickListener() {
...
//                                        itemCostTotal = arrondi(itemCostTotal);
        ...
        viewHolder.txtSelectIcon.setOnClickListener(new OnClickListener() {
        ...
        viewHolder.removeImageIcon.setOnClickListener(new OnClickListener() {
...
//        int oldCount;
        ...
        public static SerialNumberDialog getInstance(String idPiece) {
            Bundle bundle = new Bundle();
...
//                    oldCount = listSelected.size();
            ...
            adapter = new SerialNumberAdapter(getActivity(), items, idPiece);
