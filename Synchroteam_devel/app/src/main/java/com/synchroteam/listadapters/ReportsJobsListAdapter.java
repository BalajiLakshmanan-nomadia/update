 ...
 */
public class ReportsJobsListAdapter extends BaseAdapter {
	 ...
	 */
	public ReportsJobsListAdapter(Activity activity,List<HashMap<String, String>> jobCompletedList) {
