...
import com.synchroteam.utils.PinnedSectionListView.PinnedSectionListAdapter;
 ...
 */
public class UnavabilitiesListAdapter extends BaseAdapter implements
     ...
     */
    public UnavabilitiesListAdapter(Activity activity,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (unavabilityHashMap.get(KEYS.Unavabilities.IS_HEADER).equals(
                KEYS.Unavabilities.TRUE)) {
            view = layoutInflater.inflate(
                    R.layout.layout__header_alljob_listitem, null);
            ...
            view = layoutInflater.inflate(
                    R.layout.layout_unavabilities_list_item, null);
...
//            endTime = startEndTime.substring(pos + 1);
    ...
    public int getItemViewType(int position) {
        // TODO Auto-generated method stub
        int type;
        if (unavabilitiesList.get(position).get(KEYS.Unavabilities.IS_HEADER)
                .equals(KEYS.Unavabilities.TRUE)) {
     ...
     *
     * @see
     * com.synchroteam.utils.PinnedSectionListView.PinnedSectionListAdapter#
     * isItemViewTypePinned(int)
     */
    @Override
    public boolean isItemViewTypePinned(int viewType) {
        // TODO Auto-generated method stub
        return viewType == KEYS.Unavabilities.TYPE_SECTIONAL_HEADER;
    }
