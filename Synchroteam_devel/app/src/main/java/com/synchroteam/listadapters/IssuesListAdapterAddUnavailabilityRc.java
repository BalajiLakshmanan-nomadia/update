...
public class IssuesListAdapterAddUnavailabilityRc extends RecyclerView.Adapter<IssuesListAdapterAddUnavailabilityRc.ViewHolder> {
    private final Context context;
    private ArrayList<UnavailabilityBeans> unavailabilityList;
    private String selectedPos;

    private boolean isStartFragment;
    public IssuesListAdapterAddUnavailabilityRc(Context context,
    ...
    @NonNull
    @Override
    public IssuesListAdapterAddUnavailabilityRc.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rowview_unavailability_issue,viewGroup,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final IssuesListAdapterAddUnavailabilityRc.ViewHolder viewHolder, int position) {
