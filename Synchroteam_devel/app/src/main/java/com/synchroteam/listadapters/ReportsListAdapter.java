...
public class ReportsListAdapter extends BaseExpandableListAdapter
    ...
    @SuppressLint("SimpleDateFormat")
    public ReportsListAdapter(JobDetails jobDetails,
                              ArrayList<FamiliesBean> familles, Dao dataAccesssObject, int userId, int idReportModel,
...
//                    .findViewById(R.id.fieldDataKitKat);
                ...
                noteData.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String categoryName = ((FamiliesBean) getGroup(groupIndex))
                                .getNameFamily();
                        if (temp.length > 1) {
...
//        return familles.size();
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        final FamiliesBean famille = (FamiliesBean) getGroup(groupPosition);
...
//                            reportsJobDetailFragmentHelper.doOnSyncronize();
                            ...
                            famileID=famille.getIdFamily();
                            iterCount=famille.getIterationCount();

                            reportsJobDetailFragmentHelper.doOnSyncronizeAddSB(groupPosition,famileID,
                                    iterCount,false);
                        ...
                        public void onClick(DialogInterface dialog, int delete) {
                            ...
                            if (jobDetails.getUpdatedValueOfStatus() == KEYS.JObDetail.JOB__STARTED) {
                                ...
                                if (isSBDeleted) {
                                    Toast.makeText(jobDetails, jobDetails.getString(R.string.txt_ack_msg), Toast.LENGTH_SHORT).show();
//                                    reportsJobDetailFragmentHelper.doOnSyncronize();
                                    reportsJobDetailFragmentHelper.doOnSyncronizeNew(groupPosition - 1,true);
...
//        }
     ...
     * @return the int
     */
    private int infoItems(ArrayList<Item> vect) {
