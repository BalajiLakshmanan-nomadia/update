...
public class CatalogueRVAdapter extends RecyclerView.Adapter<CatalogueRVAdapter.ViewHolderCatalogue> {
    /**
     * The activity.
     */
    ...
    static CatalogueRVAdapter.SerialNumberAdapter adapter;
    ...
    public CatalogueRVAdapter(JobDetails jobDetails,
    ...
    @Override
    public CatalogueRVAdapter.ViewHolderCatalogue onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final CatalogueRVAdapter.ViewHolderCatalogue viewHolderCatalogue, @SuppressLint("RecyclerView") final int position) {
        ...
        viewHolder.dataQantitiyEt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.e("quantity", "get quantity size: " + serializable);
                if (serializable == 0) {
                    ...
                    View alertDialogView = layoutInflater.inflate(
                            R.layout.dialogaddqantity_new, null);
                    ...
                    try {
                        tempArr = previousCount.split("\\.");
                    } catch (Exception e) {
                        tempArr[0] = previousCount;
                        tempArr[1] = "0";
                        e.printStackTrace();
                    }
                    int roundQantitity = Integer.parseInt(tempArr[0]);



//                    commentEt.setFilters(new InputFilter[]{new
//                            DecimalDigitsInputFilter(5, 0)});
//
//                    commentEt.setFilters(new InputFilter[]{new
//                            DecimalDigitsInputFilter(5, 0)});
                    ...
                    commentEt.setText("" + roundQantitity);
...
//                                        itemCostTotal = arrondi(itemCostTotal);
                                    ...
                                    CatalogueRVAdapter.this.attachmentBeans.get(position)
                                            .put(KEYS.JObDetail.QTE,
                                                    pieces + "");

                                    CatalogueRVAdapter.this
        ...
        viewHolder.txtSelectIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jobDetails.getUpdatedValueOfStatus() == KEYS.JObDetail.JOB__STARTED) {
                    ...
                    CatalogueRVAdapter.SerialNumberDialog dialog = CatalogueRVAdapter.SerialNumberDialog.getInstance(hashMap
                            .get(KEYS.JObDetail.ID_ITEM));
                    ...
                    public void run() {
                        ...
                        if (serializable == 0) {
                            ...
                            if (jobDetails.getUpdatedValueOfStatus() == KEYS.JObDetail.JOB__COMPLETE) {
                                generateTextViewForRowJobCompleted(serialSelList, viewHolder.relSerialNumbers);
                            } else {
...
//                                                                idPieceSerial);
    ...
    private static void generateTextViewNew(
        ...
        for (int i = 0; i < listSel.size(); i++) {
            ...
            Typeface typeFaceAvenir = Typeface.createFromAsset(
                    ...
                    jobDetails.getResources().getString(R.string.fontName_avenir));
...
//        int oldCount;
        ...
        public static CatalogueRVAdapter.SerialNumberDialog getInstance(String idPiece) {
            Bundle bundle = new Bundle();
            bundle.putString(KEY_ID_PIECE, idPiece);
            CatalogueRVAdapter.SerialNumberDialog dialog = new CatalogueRVAdapter.SerialNumberDialog();
...
//                    oldCount = listSelected.size();
            ...
            adapter = new CatalogueRVAdapter.SerialNumberAdapter(getActivity(), items, idPiece);
            ...
            com.synchroteam.TypefaceLibrary.TextView txtConfirm = (com.synchroteam.TypefaceLibrary.TextView) dialogView
...
//                        }
    ...
    public static class SerialNumberAdapter extends BaseAdapter implements
        ...
        public View getView(final int position, View convertView,
            ...
            CatalogueRVAdapter.SerialNumberAdapter.ViewHolderAdapter holder = null;

            if (convertView == null) {

                holder = new CatalogueRVAdapter.SerialNumberAdapter.ViewHolderAdapter();
                ...
                holder = (CatalogueRVAdapter.SerialNumberAdapter.ViewHolderAdapter) convertView.getTag();
            }
            ...
            holder.textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (data.isSelected()) {
                        ...
                        //TODO CHECK REMOVE BEFORE SENDING THE BUILD
            ...
            holder.txtSelectIcon.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    CatalogueRVAdapter.SerialNumberAdapter.ViewHolderAdapter holder = (CatalogueRVAdapter.SerialNumberAdapter.ViewHolderAdapter) v.getTag();
