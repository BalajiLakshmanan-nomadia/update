...
/**
 * Adapter Class to for To Come List.
 */
public class ToComeJobsListAdapter extends BaseAdapter {
	 ...
	 *            the activity
	 * @param toComeJobList
	 *            the dedline exceeded job list
	 * @param baseFragment
	 *            the base fragment
	 */
	public ToComeJobsListAdapter(Activity activity,
			TreeMap<String, ArrayList<HashMap<String, String>>> toComeJobList,
			BaseFragment baseFragment) {

		// TODO Auto-generated constructor stub
		this.activity = activity;
		this.toComeJobList = toComeJobList;
		keySetToCome = new ArrayList<String>(toComeJobList.keySet());
	...
	public ArrayList<HashMap<String, String>> getItem(int position) {
		// TODO Auto-generated method stub
		return toComeJobList.get(keySetToCome.get(position));
	}
...
if(convertView==null) {
	convertView = layoutInflater.inflate(
			R.layout.layout_tocome_jobs_list_item, parent, false);
	...
	try {
		dateDetailCurrentJobsTv.setText(headerDateFormat
				.format(oldDatePattern.parse(keySetToCome.get(position))));
	...
	while (iterator.hasNext()) {
		View subItem = layoutInflater.inflate(R.layout.layout_to_come_item,
				parent,false);
	...
	public void notifyDataSetChanged() {
		...
		try {
			keySetToCome.clear();
			keySetToCome.addAll(toComeJobList.keySet());
		} catch (Exception e) {
			e.printStackTrace();
			Logger.printException(e);
		}
