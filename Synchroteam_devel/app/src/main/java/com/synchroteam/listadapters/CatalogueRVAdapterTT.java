...
public class CatalogueRVAdapterTT extends RecyclerView.Adapter<CatalogueRVAdapterTT.ViewHolderCatalogue> {
    /**
     * The activity.
     */
    ...
    static CatalogueRVAdapterTT.SerialNumberAdapter adapter;
    ...
    public CatalogueRVAdapterTT(JobDetails jobDetails,
    ...
    @Override
    public CatalogueRVAdapterTT.ViewHolderCatalogue onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(final CatalogueRVAdapterTT.ViewHolderCatalogue viewHolderCatalogue, final int position) {
...
//                                        itemCostTotal = arrondi(itemCostTotal);
                                        ...
                                        CatalogueRVAdapterTT.this.attachmentBeans.get(position)
                                                .put(KEYS.JObDetail.QTE,
                                                        pieces + "");

                                        CatalogueRVAdapterTT.this
        ...
        viewHolder.txtSelectIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (jobDetails.getUpdatedValueOfStatus() == KEYS.JObDetail.JOB__STARTED) {
                    ...
                    CatalogueRVAdapterTT.SerialNumberDialog dialog = CatalogueRVAdapterTT.SerialNumberDialog.getInstance(hashMap
                            .get(KEYS.JObDetail.ID_ITEM));
...
//        int oldCount;
        ...
        public static CatalogueRVAdapterTT.SerialNumberDialog getInstance(String idPiece) {
            Bundle bundle = new Bundle();
            bundle.putString(KEY_ID_PIECE, idPiece);
            CatalogueRVAdapterTT.SerialNumberDialog dialog = new CatalogueRVAdapterTT.SerialNumberDialog();
...
//                    oldCount = listSelected.size();
            ...
            adapter = new CatalogueRVAdapterTT.SerialNumberAdapter(getActivity(), items, idPiece);
...
//                        }
    ...
    public static class SerialNumberAdapter extends BaseAdapter implements
        ...
        public View getView(final int position, View convertView,
            ...
            CatalogueRVAdapterTT.SerialNumberAdapter.ViewHolderAdapter holder = null;

            if (convertView == null) {

                holder = new CatalogueRVAdapterTT.SerialNumberAdapter.ViewHolderAdapter();
                ...
                holder = (CatalogueRVAdapterTT.SerialNumberAdapter.ViewHolderAdapter) convertView.getTag();
            }
            ...
            holder.txtSelectIcon.setOnClickListener(new View.OnClickListener() {
                ...
                @Override
                public void onClick(View v) {
                    CatalogueRVAdapterTT.SerialNumberAdapter.ViewHolderAdapter holder = (CatalogueRVAdapterTT.SerialNumberAdapter.ViewHolderAdapter) v.getTag();
