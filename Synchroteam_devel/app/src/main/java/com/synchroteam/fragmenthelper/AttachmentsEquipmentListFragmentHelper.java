...
/**
 * The Class AttachmentsEquipmentListFragmentHelper is to inflate and control
 * all the actions performed in attachments description screen.
 *
 * @author Trident
 */
public class AttachmentsEquipmentListFragmentHelper implements HelperInterface {
     ...
     * @param clientId
     */
    public AttachmentsEquipmentListFragmentHelper(
            EquipmentDetials syncoteamNavigationActivity, int equipmentId) {
    ...
    private class FetchAttachmentDataFromDb extends AsyncTaskCoroutine<Void, Void> {
        ...
        public Void doInBackground(Void... params) {
            ...
            attachmentsBeans.addAll(dataAccessObject
                    .getEquipmentAttachmentList(equipmentId));
