...
public class ReportsJobDetailFragmentHelper implements HelperInterface, View.OnTouchListener {
    ...
    public ReportsJobDetailFragmentHelper(JobDetails jobDetails, int idModel,
...
//            }
        ...
        if (reportsExpandableListAdapter == null) {
            ...
            if (listItem != null && listItem.size() > 0) {
                reportsExpandableListAdapter = new ReportsExpandableListAdapter(
...
//        attachmentDialog.prendrePhoto();
    ...
    private class AttachReportAsyncTask extends
        ...
        public AttachReportAsyncTask(ReportsJobDetailFragmentHelper
