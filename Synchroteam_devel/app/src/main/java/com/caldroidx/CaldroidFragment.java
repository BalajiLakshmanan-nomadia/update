...
public class CaldroidFragment extends DialogFragment {
    ...
    private Map<DateTime, DateTimeAlongWithJobsCountBean> selectedDatesWithJobs;
     ...
     */
    public void setSelectedDatesWithJob(Map<DateTime, DateTimeAlongWithJobsCountBean> selectedDatesWithJobs){
                ...
                public void onItemClick(AdapterView<?> parent, View view,
                    ...
                    if (caldroidListener != null) {
                        ...
                        Date date = CalendarHelper
                                .convertDateTimeToDate(dateTime.getDateTime());
